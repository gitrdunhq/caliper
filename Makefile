...
.PHONY: quality-check format lint test test-build test-amd64 prod-build prod-smoke dev setup-dev reinstall dogfood preflight part-ui complexity-helper
...
complexity-helper:
	bash scripts/build_complexity_helper.sh
