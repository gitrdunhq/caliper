"""Tests for ``cli.part_render``'s pure rendering helpers.

# tested-by: tests/unit/test_part_render.py

``render_cutlist_diff`` formats what changed between two cut lists (#524) so
...
from caliper.cli.part_render import render_cutlist_diff
