...
Caliper — fully deterministic dependency and code review for CI. 19 scanner plugins (+ OPA policy plugin), 21 deterministic detectors, 67 custom semgrep rules, 12 code graph checks, 15 OPA policy rules, 600+ tests, zero LLM in the decision path.
