...
caliper already knows a version changed, but until now never looked at the diff.
...
# Conservative defaults — overridable by the caller (CaliperSettings in the pipeline).
