"""Published schema for `caliper review --format json` output (#389).
...
is regenerated with ``caliper schema --output docs/schema/report-v1.0.json``.
...
class ReportModel(BaseModel):
    """Top-level document emitted by ``caliper review --format json``."""
    ...
    # Verdict counts (single source of truth — caliper.core.review_summary). Additive
