<div align="center">
  ...
  16 plugins. 6 OPA policy rules. 18 ecosystems. Zero LLM in the decision path.
  <br><br>

  <a href="../README.md#quick-start"><img src="https://img.shields.io/badge/get_started-→-d4251a?style=flat-square" alt="Get Started"></a>
  <a href="../README.md#the-16-plugins"><img src="https://img.shields.io/badge/16_plugins-deterministic-f2c14a?style=flat-square&labelColor=0e0706" alt="16 Plugins"></a>
...
Drop it into your CI pipeline. It runs 16 scanners on every PR, evaluates findings against policy rules you control, and posts a clear verdict: **BLOCKED**, **WARNINGS**, or **ALL CLEAR** with a 0-100 health score.
...
4. **One comment, not sixteen.** All 16 scanners produce one unified PR comment with a single verdict. Your engineers read one thing, not one alert per tool.
...
- **`.caliper.yaml`** — enable/disable any of the 16 plugins, set thresholds, configure per-repo
